        ...
        <div class="rightBody">
            <div class="panel rightPanel">
                <div class="panel_body1">
                    ...
                    <p>&nbsp&nbsp You can collect Information about the user performing the test e.g. Name, Email, Location, Business Unit, etc</p>
                    <div class="buttonOptions1">
                        ...
                        <div class="panel-body">
                            <p><label for="Question"><b>Question:</b></label></p>
                            ...
                            <select style="width: 500px; height: 35px;">
                                ...
                                <div class="buttonOptions1"><a href="Adduserdata2.php" />
