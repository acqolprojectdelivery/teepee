		...
		<nav class="menu">	
			...
			<div class="menuOptions">
				<ul id="menuItems">
	                ...
	                <li><a href="#" class="active"><b>Create New Test</b></a></li>
		...
		<div class="leftBody">
			<div class="panel leftNavBarPanel">
						<ul>
							...
							<a href="#"><li>Add Text Content</li></a>
                                                        <a href="#"><li class="leftPanelActive">Add User Data</li></a>
...
<div class="panel-body">
  ...
  <option value="Combo Box">Combo Box</option></p><br><br><br>
 <div class="buttonOptions2" >
